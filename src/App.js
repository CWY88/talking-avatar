...
//   return (
//     <Canvas shadows camera={{ position: [0, 0, 15], fov: 30 }}>
//       {/* 使用 Environment 但禁用背景 */}
//       <Environment
//         files="/snowy_forest_path_01_4k.hdr"
//         background={false} // 禁用背景，仅用于光照
//       />
...
export default function App() {
  ...
  return (
    <Canvas shadows camera={{ position: [0, 0, 15], fov: 30 }}>
      ...
      {/* 替换为直接加载 Sadie.glb 文件 */}
      <SadieModel position={[0, 0, 3]} scale={1.8} />
...
function SadieModel(props) {
  const { nodes, materials } = useGLTF('/Sadie.glb'); // 加载 Sadie.glb 文件
...
useGLTF.preload('/Sadie.glb'); // 预加载 Sadie.glb 文件
